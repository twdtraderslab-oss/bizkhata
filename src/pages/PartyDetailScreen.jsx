...
<div style="margin-top:24px;text-align:center;font-size:11px;color:#d1d5db">Generated by BizKhata · ${new Date().toLocaleString('en-IN')}</div>
</div></body></html>`
}
